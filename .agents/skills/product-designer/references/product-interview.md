...
5. **渐进式展示你的 design**。逐步书写并展示你的设计，获得批准后再继续推进你的设计。最终你会产出一个 `docs/plans/YYYY-MM-DD-HH-MM/<topic>-design.md` 文档。
