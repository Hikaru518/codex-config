...
description: "Only use when the user explicitly enters `$test-driven-development`, or developer explicitly requires TDD for a bounded coding task. Use before writing implementation code."
---
